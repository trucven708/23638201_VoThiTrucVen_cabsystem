...
### BR07 – Quy tắc hủy chuyến

Booking có thể bị hủy trước khi hoàn thành.

Khi hủy chuyến, hệ thống phải:

- Cập nhật trạng thái booking.
- Ghi nhận thời gian hủy.
- Ghi nhận người thực hiện hủy.
- Gửi thông báo cho các bên liên quan.

---

### BR08 – Quy tắc tính cước

Cước chuyến được tính dựa trên:
...
### BR09 – Quy tắc thanh toán

Chuyến chỉ được xác định là **Paid** khi hệ thống nhận được kết quả thanh toán thành công.

Nếu thanh toán thất bại, hệ thống cho phép thực hiện lại thanh toán:
...
flowchart TD
    ...
    H -->|Không| I["Tìm tài xế tiếp theo"]
    I --> E
    ...
    N -->|Không| O["Thanh toán lại"]
    O --> N

    N -->|Có| P["Lưu giao dịch"]

    P --> Q["Khách hàng đánh giá"]

    Q --> R["Kết thúc"]

    style A fill:#1f4e78,color:#fff
    style R fill:#38761d,color:#fff
    style C fill:#f4cccc
    style F fill:#f4cccc
    style O fill:#fff2cc
